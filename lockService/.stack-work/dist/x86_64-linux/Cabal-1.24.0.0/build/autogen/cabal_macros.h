...
/* package lockService-0.1.0.0 */
#define VERSION_lockService "0.1.0.0"
#define MIN_VERSION_lockService(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "lockService-0.1.0.0-CFjckCRDVw87xljesJbFl3"

#define CURRENT_PACKAGE_KEY "lockService-0.1.0.0-CFjckCRDVw87xljesJbFl3"
