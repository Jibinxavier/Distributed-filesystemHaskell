...
/* package filesystem-api-0.1.0.0 */
#define VERSION_filesystem_api "0.1.0.0"
#define MIN_VERSION_filesystem_api(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
/* package warp-tls-3.2.2 */
#define VERSION_warp_tls "3.2.2"
...
#define CURRENT_COMPONENT_ID "auth-server-0.1.0.0-LHjSYKct00aD4WQY3RKNIZ"

#define CURRENT_PACKAGE_KEY "auth-server-0.1.0.0-LHjSYKct00aD4WQY3RKNIZ"
